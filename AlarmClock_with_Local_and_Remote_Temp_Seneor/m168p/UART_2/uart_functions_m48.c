...
uint8_t read_sensor[3];
uint8_t write_sensor[2];
...
{
  uart_init();
  twi_start_wr(0x40, write_sensor, 1); //Start condition
  twi_start_wr(0xE3, write_sensor, 1);
  twi_start_rd(0x40, read_sensor, 2);
